...
import { Flexbox, Icon, SideNav, Tooltip } from '@boxops/components-2';
import React from 'react';
import { iconColor, semanticColor } from '@boxops/components-2/src/tokens.stylex';
        ...
        <Example>
          <Example.Demo>
            <Tooltip label="This is a tooltip">
              <Icon.Info variant="solid" style={styles.icon} />
            </Tooltip>
          </Example.Demo>
        </Example>
